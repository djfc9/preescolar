 ...
 */
	public function view($id = null) {
		if (!$this->Salud->exists(base64_decode($id))) {
			throw new NotFoundException(__('Invalid salud'));
		}
		$options = array('conditions' => array('Salud.' . $this->Salud->primaryKey => base64_decode($id)));
 ...
 */
	public function add($cedula_e = null) {
		...
		$alumnos = $this->Salud->Alumno->find('list' , array('conditions'=>array('Alumno.cedula_escolar'=>  base64_decode($cedula_e))));
 ...
 */
	public function delete($id = null) {
		$this->Salud->id = base64_decode($id);
