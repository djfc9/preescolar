...
'folderPermission' => 777, // Set permission of dynamically created folder
...
'filePermission' => 777 , // Set permission of uploaded files in the server
...
'Empty' => array(
'message' => __d('meio_upload', 'No se ha Seleccionado una Foto.')
),
'UploadError' => array(
'message' => __d('meio_upload', 'There were problems in uploading the file.')
),
'MaxSize' => array(
'message' => __d('meio_upload', 'Foto excede el tamaño maximo.')
),
'InvalidMime' => array(
'message' => __d('meio_upload', 'Solo se Permiten fotos .jpg, .jpeg y .png')
),
'InvalidExt' => array(
'message' => __d('meio_upload', 'Formato de foto es invalido.')
),
'MinWidth' => array(
