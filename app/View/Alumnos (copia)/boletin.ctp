...
$pdf->Ln(1);
	...
	$pdf->Ln(2);
        ...
        $pdf->SetFont('Arial','',8);
        $pdf->Cell(147,6, utf8_decode('El Boletín Informativo es un instrumento que permite dar a conocer a los padres, representantes información sobre') ,0,1,'J');
        $pdf->Setx(17);
       ...
       // $pdf->SetFont('Arial','',8);
        ...
        $pdf->Setx(36);
        $pdf->SetFont('Arial','B',6);
        $pdf->Cell(20,4, ucwords(utf8_decode('Janet Arvelaiz')) ,0,0,'J');
        $pdf->Cell(40,4, utf8_decode('                             ') ,0,0,'J');
