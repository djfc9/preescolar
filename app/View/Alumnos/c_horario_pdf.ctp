...
$pdf->Ln(20);
	...
	$pdf->Ln(15);
        ...
        $pdf->Cell(155,10, utf8_decode('Quien suscribe, '.ucwords($director).'     Director (a) del C.E.I "Bolívar Niño", por medio  de  la  presente').' ' ,0,1,'');
        ...
        $pdf->Setx(100);
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(8, 4, utf8_decode(ucwords($director)),0,1,'C');
        /*$pdf->Setx(100);
        $pdf->Cell(8, 4, utf8_decode('Supervisor Docente Jefe'),0,1,'C');*/
        $pdf->Setx(100);
        $pdf->Cell(8, 4, utf8_decode('Director (a) del CEI Bolívar Niño'),0,1,'C');
