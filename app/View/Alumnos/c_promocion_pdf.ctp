...
$pdf->Ln(20);
  ...
  //año escolar
        ...
        $pdf->Cell(8, 10,'__________________________',0,1,'C');
         $pdf->Setx(55);
        $pdf->SetFont('Arial','B',11);
        $pdf->Cell(8, 4, utf8_decode(ucwords($director)),0,0,'C');
        $pdf->Setx(150);
        $pdf->Cell(8, 4, utf8_decode('_____________________'),0,1,'C');
        $pdf->Setx(150);
        $pdf->Cell(8, 6, utf8_decode('Docente de Grupo 3ro: "_____"'),0,1,'C');
        //$pdf->Setx(150);
        //$pdf->Cell(8, 6, utf8_decode('_____________________'),0,1,'C');
        $pdf->Setx(55);
        $pdf->Cell(8, 3, utf8_decode('Director (a) del CEI Bolívar Niño'),0,1,'C');
        /*$pdf->Setx(55);
