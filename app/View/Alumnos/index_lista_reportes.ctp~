			...
			<?php $this->Form->create(); 
                        ...
                        ?>
                            <?php echo $this->Form->input('acciones_rep',array('type'=>'select','options'=>array(
                                ...
                                '/preescolar/alumnos/c_retiro/'."$id"=>'Constancia de retiro',
				'/preescolar/alumnos/c_horario/'."$id"=>'Constancia de Horario',
				'/preescolar/alumnos/c_promocion/'."$id"=>'Boleta de Promocion',
                                 '/preescolar/alumnos/c_direccion/'."$id"=>'Dirección de habitación',),'empty'=>'Seleccione','label'=>false) ); ?>
