...
<div class="flotados5">
    <?php
        echo $this->Form->input('Ficha.Alumno.cedula_escolar', array('onkeypress'=>"return soloNumeros(event)",'style'=>'width: 150px;', 'label'=>'Cedula Escolar','placeholder'=>'Ejm. 11209568332'));
