...
<?php  echo $this->Form->create('Persona', array('type'=>'file')); ?> 
	<fieldset>
		...
		<?php echo $this->Form->input('cedula', array('style'=>'width: 200px;','maxlength'=>'8')); ?>
          ...
          <tr>
                <td>
                <?php echo $this->Form->input('telefono_movil', array('style'=>'width: 200px;','maxlength'=>'11')); ?>
                </td><td>
                <?php echo $this->Form->input('telefono_local', array('style'=>'width: 200px;','maxlength'=>'11')); ?>
                </td><td>
		<?php echo $this->Form->input('telefono_trabajo', array('style'=>'width: 200px;','maxlength'=>'11')); ?>
                </td>
           </tr>
           <tr>
                <td>
		...
		<?php echo $this->Form->input('estado_id', array('style'=>'width: 200px;')); ?>
           ...
           <tr>
                <td>
                <?php echo $this->Form->input('direccion', array('style'=>'width: 250px;')); ?>
		...
		<?php echo $this->Form->input('tipo_persona_id', array('style'=>'width: 200px;', 'empty'=>'Seleccione', 'label'=>'Parentesco')); ?>
