...
<?php echo $this->Form->create('User'); ?>
	...
	<?php
		echo $this->Form->input('username', array('style'=>'width: 250px;', 'label'=>'Usuario', 'autofocus'));
                ...
                echo $this->Form->input('group_id', array('style'=>'width: 250px;', 'label'=>'Grupo de usuarios'));
                echo $this->Form->input('empleado', array('style'=>'width: 250px;', 'type'=>'hidden', 'value'=>'1'));
	?> 
                </div>
                    </center>
	</fieldset>
