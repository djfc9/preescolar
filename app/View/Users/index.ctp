	...
	<tr>
		...
		<td class="actionss"> 
	            ...
	            <?php echo $this->Html->image('editar.png', array('width'=>'40px;', 'heigth'=>'40px;', 'alt'=>'Editar','title'=>'Editar',
                    ...
                    <?php echo $this->Html->image('cambiar_grupo.png', array('width'=>'40px;', 'heigth'=>'40px;', 'alt'=>'Cambiar Grupo','title'=>'Cambiar Grupo',
                            'url'=>array('action' => 'edit_2', base64_encode($user['User']['id'])))); ?>
