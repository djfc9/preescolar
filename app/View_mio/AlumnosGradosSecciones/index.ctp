...
<div class="alumnosGradosSecciones index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $alumnosGradosSeccione['AlumnosGradosSeccione']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $alumnosGradosSeccione['AlumnosGradosSeccione']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $alumnosGradosSeccione['AlumnosGradosSeccione']['id']), null, __('Are you sure you want to delete # %s?', $alumnosGradosSeccione['AlumnosGradosSeccione']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
