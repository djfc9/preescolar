...
<li><a href="#"><span>Perfil</span></a>
    ...
    <li><a href="#">Consultar</a>
      <ul>
       <li><a href="/preescolar/Personas/viewalumnos/<?php echo $usuario; ?>"><span>Representados</span></a></li>
        <li><a href="/preescolar/personas/viewautorizados/<?php echo $usuario; ?>"><span>Autorizados</span></a></li>
      </ul>
    </li>
