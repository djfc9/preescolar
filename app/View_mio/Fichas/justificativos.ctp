...
<?php echo $this->Form->create(Null, array('type'=>'post','controller'=>'Fichas', 'action'=>'justificativos_pdf')); ?>
	<fieldset>
		<legend><?php echo __('Planilla de Justificativos M&eacute;dicos'); ?></legend>
        ...
        ?></div></div>
            ...
            <tr>
                ...
                <td colspan="2" border='1' class='flotados2'>
                    <p align='center'>Asistio a la consulta medica en el horario comprendido</p>
                </td>
            </tr>
            <tr>
