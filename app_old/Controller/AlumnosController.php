...
///cierre del else que verifica si hay cupos disponibles
		...
		//echo debug($alum_busqueda);
                ...
                $gradoseccion = $this->Alumno->AlumnosGradosSeccione->find('all',
                        array('fields'=>'AlumnosGradosSeccione.grados_seccione_id',
                                'conditions'=> 
                            array('And'=>
                ...
                $this->Alumno->GradosSeccione->recursive = -1;
                $gradosSecciones = $this->Alumno->GradosSeccione->find('first', 
                        array('fields'=>'GradosSeccione.descripcion',
        ...
        public function viajess($id) {
                ...
                $this->layout ='ajax';
                $this->Alumno->GradosSeccione->recursive = -1;
                $gs = $this->Alumno->AlumnosGradosSeccione->find('list',
                        array('fields'=>array('AlumnosGradosSeccione.alumno_id'),
       ...
       public function autorizados(){
           ...
           Configure::write('debug', '0');
           $gradosSeccione = $this->Alumno->GradosSeccione->find('list', 
                   array('order'=>'GradosSeccione.descripcion Asc',
			'conditions'=>array('GradosSeccione.ano_escolar'=>$ano_escolar),
                        'fields'=>array('GradosSeccione.id','GradosSeccione.descripcion')));
                $this->set('gradosSec', $gradosSeccione);
       }   
	...
	public function autorizados_rep($id){
            ...
            Configure::write('debug', '0');
                $this->layout ='ajax';
                $a = $this->Alumno->AlumnosGradosSeccione->find('list', 
                        array('fields'=>array('AlumnosGradosSeccione.alumno_id'),
                            'conditions'=>array('AlumnosGradosSeccione.grados_seccione_id'=>$id)));
...
///////////////////////////////////////////////////////
    ...
    public function boletines($id){
        ...
        $this->set(compact('alumnos','gradosSeccion'));
        App::import('Vendor', 'Fpdf', array('file' => 'fpdf/fpdf.php'));
        $this->layout = 'pdf'; 
        $this->set('fpdf', new FPDF('L', 'mm', 'A4'));
        $this->render('boletin');
