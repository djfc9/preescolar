...
$pdf->Ln(20);
	...
	$pdf->Ln(15);
        ...
        $pdf->Cell(42,10, utf8_decode('Quien suscribe, Prof.') ,0,0,'');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(30,10, utf8_decode('Elba Ramos').',  ' ,0,0,'');
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(80,10, utf8_decode('titular  de  la  cedula  de  identidad  No:') ,0,0,'');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(36,10, utf8_decode('13.586.981').',  ' ,0,1,'');
        $pdf->SetFont('Arial','',12);
        ...
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(28,7, utf8_decode($grupo) ,'B',0,'J');
        $pdf->SetFont('Arial','',12);
	...
	$pdf->Ln(15);
        ...
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(38, 10, utf8_decode('cursante del Grupo'),0,0,'J');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(25, 7,utf8_decode($grupo),'B',0,'C' );
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(31, 10, utf8_decode('del año escolar'),0,0,'J');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(22, 7, utf8_decode($ano_escolar),'B',0,'J');
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(32, 10, utf8_decode('. A solicitud de su representante'),0,1,'J');
        $pdf->Cell(0, 10, utf8_decode('se le hace entrega de su expediente completo con su debida documentación.'),0,0,'J');
        $pdf->Ln(30);
        $pdf->Setx(19);
