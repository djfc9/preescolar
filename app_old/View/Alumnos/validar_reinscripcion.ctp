        ...
        echo "</div>";
                ?>
                 ...
                 <table align="center">
                    ...
                    <?php
                  /*  echo $this->Form->input('GradosSeccione', array('label'=>'Grado y Secci&oacute;n'));
                    echo "</td><td>";
                    echo $this->Form->input('estatu_id', array('label'=>'Estatus de inscripción', 'empty'=>'Seleccione'));
