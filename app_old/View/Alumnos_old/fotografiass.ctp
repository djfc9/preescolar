...
<?php echo $this->Html->image('pdf_report.png', array('class'=>'botones_superiores', 
    'title'=>'Imprimir Reporte','width'=>'52px;', 'heigth'=>'72px;','url'=>array('action'=>'fotografias_pdf', $id)));
 ?>
</div>
