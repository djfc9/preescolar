...
$pdf->Ln(10);
   ...
   //     $pdf->Cell(0,8,'BASE DE DATOS DEL: '.strtoupper($descripcion)." ".$ano_escolar ,0,1,'C');
        ...
        $pdf->Cell(18,6,strtoupper('Edad S.') ,1,0,'C', true); 
        $pdf->Cell(70,6,strtoupper('Representante') ,1,0,'C',true);   
        $pdf->Cell(22,6,strtoupper('Parent') ,1,0,'C', true);
        $pdf->Cell(15,6,strtoupper('Ente') ,1,0,'C', true); 
        $pdf->Cell(82,6,strtoupper('Correo') ,1,0,'C', true); 
...
//echo $años1."-".$meses1."<br>";
	     ...
	     $pdf->Cell(22,5,utf8_decode(strtoupper($datos['0']['parentesco'])) ,1,0,'C');
             ...
             case 'GRUPO 3-B':
              ...
              case 'GRUPO 3-C':
			   ...
			   $pdf->Cell(15,5,utf8_decode(strtoupper($ente)) ,1,0,'C');
                           $pdf->Cell(82,5,strtoupper($datos['0']['correo']) ,1,0,'L');
			 $pdf->Ln();
