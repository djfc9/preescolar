<div class="contenido_principal">
	...
	<tr>
		...
		<td>
			...
			<?php /* echo $this->Html->link(__('Ver'), array('action' => 'view', $comida['Comida']['id'])); ?>
			<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $comida['Comida']['id'])); ?>
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $comida['Comida']['id']), array(), __('Seguro quiere elimiar este menú # %s?', $comida['Comida']['id'])); */ ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
