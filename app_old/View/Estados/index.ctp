<div class="estados index">
	...
	<tr>
			<th><?php echo $this->Paginator->sort('id_estado'); ?></th>
			<th><?php echo $this->Paginator->sort('descripcion'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($estados as $estado): ?>
	<tr>
		<td><?php echo h($estado['Estado']['id_estado']); ?>&nbsp;</td>
		<td><?php echo h($estado['Estado']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $estado['Estado']['id_estado'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $estado['Estado']['id_estado'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $estado['Estado']['id_estado']), null, __('Are you sure you want to delete # %s?', $estado['Estado']['id_estado'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
