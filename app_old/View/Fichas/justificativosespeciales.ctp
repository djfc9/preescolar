...
$pdf->AddPage('P','Letter');
	...
	$pdf->SetFont('Arial','',10);
        ...
        $pdf->Setx(65);
        $pdf->MultiCell(90,8, utf8_decode('INSTITUTO NACIONAL DE DEPORTES PREESCOLAR "BOLIVAR NIÑO".'),0,'C');
        $pdf->Setx(20);
        $pdf->Ln(20);
        ...
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(0,10, utf8_decode('  asistió  a  este  centro  educativo,  en'),0,1,'J');
        $pdf->Cell(38,10, utf8_decode('representación de:'),0,0,'');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(64,7, utf8_decode($nombre_al.' '.$apellido_al) ,'B',0,'C');
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(1,10, utf8_decode(',') ,0,0,'J'); 
        $pdf->Cell(75,10, utf8_decode(' estudiante Activo de esta  institución,  el') ,0,1,'J');
        $pdf->Cell(10,10, utf8_decode('día') ,0,0,'');
        $pdf->SetFont('Arial','B',12);
