...
$pdf->Ln(10);
	...
	$pdf->Ln(23);
        ...
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(70,13, utf8_decode('titular  de  la  Cédula  Escolar  No:   ') ,0,0,'');
        $pdf->SetFont('Arial','B',12);
        ...
        $pdf->SetFont('Arial','',12);
        $pdf->Cell(46,12, utf8_decode('durante el año escolar') ,0,0,'');
        $pdf->SetFont('Arial','B',12);
