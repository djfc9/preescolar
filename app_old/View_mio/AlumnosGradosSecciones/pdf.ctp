...
$pdf->Ln(10);
	...
	$pdf->Ln(2);
        ...
        $pdf->Cell(40,6,strtoupper('Apellido') ,1,0,'L', true); 
        $pdf->Cell(40,6,strtoupper('2do. Apellido') ,1,0,'L', true); 
        $pdf->Cell(25,6,strtoupper(utf8_decode('Teléfono')) ,1,0,'L',true);   
        $pdf->Cell(15,6,strtoupper('Sexo') ,1,0,'L', true);
        $pdf->Cell(25,6,strtoupper('Fecha Na') ,1,0,'L', true); 
...
$edad = $años." años / ".$meses."  Meses";
             ...
             $pdf->Cell(40,5,utf8_decode(strtoupper($datos['Alumno']['apellido'])) ,1,0,'L');
             $pdf->Cell(40,5,utf8_decode(strtoupper($datos['Alumno']['segundo_apellido'])) ,1,0,'L');
