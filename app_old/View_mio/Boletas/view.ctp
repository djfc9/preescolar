...
<h2><?php echo __('Boleta'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($boleta['Boleta']['resultado']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Boleta'), array('action' => 'delete', $boleta['Boleta']['id']), null, __('Are you sure you want to delete # %s?', $boleta['Boleta']['id'])); ?> </li>
